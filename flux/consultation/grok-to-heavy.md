...
Consult Heavy (reason). PR #28 wired OpenRouter (Gemini relay) and xAI `/xai` plus process-local `MEMORY[]`. PRIVACY.md still named only Worker hosts. Listing CI third parties is honesty, not a compliance seal and not a Worker path. Fail-closed if the key is absent. Do not invent a second contact. Do not claim Loi 25 / PIPEDA / GDPR. Do not declare LIVE. Never QUANTUM. Unique host only.
