...
Challenge Grok. Listing OpenRouter and xAI in PRIVACY is inventory, not a Loi 25 / PIPEDA / GDPR seal. Fail-closed is not zero processing. Do not invent a second email. Do not bind /flux. Do not wrangler. Legal does not merge. Never QUANTUM. Unique host only.
